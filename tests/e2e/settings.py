...
def destroy_targets(config):
    ...
    stacks = config.getoption("--destroy-stack") or [
        ...
        stack_name("private", STACK_SUFFIX),
        stack_name("byovpc", STACK_SUFFIX),
        stack_name("byovpc-private", STACK_SUFFIX),
        stack_name("byosubnet", STACK_SUFFIX),
        stack_name("byosubnet-private", STACK_SUFFIX),
        stack_name("byodns", STACK_SUFFIX),
        stack_name("byodns-private", STACK_SUFFIX),
    ]
