"""
AWS-specific setup wizard for Pinecone BYOC deployment.

Contains AWSSetupWizard class with 13 steps, AWS credential validation,
AWS preflight checks, and generates AWS-specific Pulumi project files.
"""
...
try:
    from .wizard import _read_input_with_placeholder, PreflightResult, BLUE
except ImportError:
    from wizard import _read_input_with_placeholder, PreflightResult, BLUE
...
class AWSSetupWizard:
    ...
    def run(self, output_dir: str = ".") -> bool:
        ...
        # step 8: get public access preference
        public_access = self._get_public_access()

        # step 9: get custom tags
        tags = self._get_tags()
        ...
        # step 11: get project name
        project_name = self._get_project_name()

        # step 12: set up pulumi backend
        if not self._setup_pulumi_backend():
            return False

        # step 13: generate project
    ...
    def _print_header(self):
        ...
        console.print(
            Panel.fit(
                f"[bold {BLUE}]Pinecone BYOC Setup Wizard (AWS)[/]",
                border_style=BLUE,
                padding=(0, 2),
            )
        )
        console.print()
        console.print(
            "  This wizard will set up everything you need to deploy Pinecone BYOC on AWS.",
            style="dim",
        )
        console.print()
    ...
    def _generate_project(
        ...
        """Generate complete Pulumi project for AWS."""
        console.print()
        ...
        pulumi_yaml = {
            ...
            "description": "Pinecone BYOC deployment (AWS)",
        }
...
"""
        ...
        # create stack config (all kebab-case keys)
        stack_name = "prod"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Pinecone BYOC AWS Setup Wizard")
    parser.add_argument(
