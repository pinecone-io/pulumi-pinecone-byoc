...
class Output(Generic[T_co]):
    ...
    def __init__(
        self,
        resources: Awaitable[set[Any]] | set[Any],
        future: Awaitable[T_co],
        is_known: Awaitable[bool],
        is_secret: Awaitable[bool] | None = None,
    ) -> None: ...
    def resources(self) -> Awaitable[set[Any]]: ...
    def future(self, with_unknowns: bool | None = None) -> Awaitable[T_co | None]: ...
